...
public class BeerDetailViewController: UIViewController {
    
    static func createViewController(beerId: Int) -> UIViewController {
        let storyBoard = UIStoryboard(name: "BeerDetailViewController", bundle: nil)
    ...
    @IBOutlet weak var brewerTips: UILabel!
